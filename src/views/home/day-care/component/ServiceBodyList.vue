 ...
 * @LastEditTime: 2023-02-04 16:20:42
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \city-yanglao-H5\src\views\home\day-care\component\ServiceBodyList.vue
 * 
 -->
 <template>
  <div class="container">
    ...
    >
      <div class="activity" @click="activityClick(item, 'item')">
        <img :src="item.envPics[0].url" alt="" />

        <div class="content">
          <span class="title">{{item.orgName}}</span>
          <!-- <span class="time">提供餐别：{{item.mealCategory}}</span> -->
        </div>
      </div>
