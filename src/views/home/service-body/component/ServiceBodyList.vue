 ...
 * @LastEditTime: 2022-12-02 15:47:08
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \city-yanglao-H5\src\views\home\service-body\component\ServiceBodyList.vue
 * 
 -->
 <template>
  <div class="container">
    ...
    >
      <div class="activity" @click="activityClick(item, 'item')">
        ...
        <div class="content">
          ...
          <span class="time">床位数：{{item.bedNum}}</span>
        </div>
      </div>
