!(function (e, t) {
  ...
  function h(e, t, i, n) {
    var a = e.toString().split("."),
      r = t - (n || 0),
      o = 2 === a.length ? Math.min(Math.max(a[1].length, r), t) : r,
      s = Math.pow(10, o),
  ...
  function f(e, t, i, n) {
    ...
    (i = i || ""),
      ...
      ~i.indexOf("(")
        ? ((r = !0), (i = i.replace(/[(|)]/g, "")))
        : (~i.indexOf("+") || ~i.indexOf("-")) &&
          ((b = ~i.indexOf("+") ? i.indexOf("+") : t < 0 ? i.indexOf("-") : -1),
          (i = i.replace(/[+|-]/g, ""))),
      ~i.indexOf("a") &&
        ((v = !!(v = i.match(/a(k|m|b|t)?/)) && v[1]),
        ~i.indexOf(" a") && (s = " "),
        (i = i.replace(new RegExp(s + "a[kmbt]?"), "")),
        (a >= u && !v) || "t" === v
          ? ((s += e.abbrLabel.tr), (t /= u))
          : (a < u && a >= d && !v) || "b" === v
          ? ((s += e.abbrLabel.bi), (t /= d))
          : (a < d && a >= m && !v) || "m" === v
          ? ((s += e.abbrLabel.mi), (t /= m))
          : ((a < m && a >= p && !v) || "k" === v) &&
            ((s += e.abbrLabel.th), (t /= p))),
      ~i.indexOf("[.]") && ((o = !0), (i = i.replace("[.]", ".")));
    var y = t.toString().split(".")[0],
      g = i.split(".")[1],
      x = i.indexOf(","),
    ...
    if (
      (g
        ? ((y = (c = ~g.indexOf("[")
            ? h(
                t,
                (g = (g = g.replace("]", "")).split("["))[0].length +
                  g[1].length,
                n,
                g[1].length
              )
            : h(t, g.length, n)).split(".")[0]),
          (c = ~c.indexOf(".") ? "." + c.split(".")[1] : ""),
          o && 0 == +c.slice(1) && (c = ""))
        : (y = h(t, 0, n)),
      s &&
        !v &&
        ...
        s !== l.trillion &&
        ((y = "" + +y / 1e3), (s = l.million)),
      ~y.indexOf("-") && ((y = y.slice(1)), (f = !0)),
      y.length < w)
    )
      for (var S = w - y.length; S > 0; S--) y = "0" + y;
    x > -1 && (y = y.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")),
      i.indexOf(".") || (y = "");
    var A = y + c + (s || "");
    return (
      r
  ...
  function g(e, t, i) {
    return (function (e, t, i) {
      ...
      var n = void 0,
        a = void 0;
      if (0 === e && null !== b.zeroFormat) n = b.zeroFormat;
      else if (null === e && null !== b.nullFormat) n = b.nullFormat;
      else {
        for (var r in y)
          if (y[r] && t.match(y[r].regexp)) {
            a = y[r].format;
            break;
          }
      ...
      0 === e || void 0 === e
        ...
        ? null
        : "string" == typeof e
        ? b.zeroFormat && e === b.zeroFormat
          ? 0
          : (b.nullFormat && e === b.nullFormat) ||
  ...
  v(b, c),
    (g.options = b),
    (g._numberToFormat = f.bind(null, b)),
    ...
    g.register("percentage", {
      ...
      format: function (e, t, i, n) {
        ...
        return (
          ...
          (t = t.replace(/\s?%/, "")),
          ~(r = n._numberToFormat(e, t, i)).indexOf(")")
            ? ((r = r.split("")).splice(-1, 0, a + "%"), (r = r.join("")))
            : (r = r + a + "%"),
          r
        );
      },
  ...
  var z = function (e, t, i) {
    ...
    H = function (e) {
      var t,
        i = e.position,
        n = e.positionJsonLink,
        a = e.beforeRegisterMapOnce,
        r = e.mapURLProfix,
        o = n || "" + r + i + ".json";
      return (
        C[o] ||
    ...
    P = function (e, t) {
      return (
        F ||
          (F = new Promise(function (i, n) {
            var a = "bmap" + Date.now();
            window[a] = i;
            var r = document.createElement("script");
            (r.src = [
              "https://api.map.baidu.com/api?v=" + (t || "2.0"),
              "ak=" + e,
              "callback=" + a,
            ].join("&")),
    ...
    D = function (e, t) {
      return (
        _ ||
          (_ = new Promise(function (i, n) {
            var a = "amap" + Date.now();
            window[a] = i;
            var r = document.createElement("script");
            (r.src = [
              "https://webapi.amap.com/maps?v=" + (t || "1.4.3"),
              "key=" + e,
              "callback=" + a,
            ].join("&")),
              document.body.appendChild(r);
  ...
  function B(e) {
    for (
      var t = e.meaAxisName,
        ...
        o = e.min,
        s = e.max,
        l = { type: "value", axisTick: { show: !1 }, show: n },
        c = [],
        u = function (e) {
          i[e]
            ? (c[e] = S({}, l, {
        ...
        formatter: function (e) {
          ...
          return (
            ...
            e.forEach(function (e) {
              var i = e.seriesName,
                o = ~s.indexOf(i) ? n[1] : n[0];
              t.push(r(e.color)),
                t.push(i + ": "),
                t.push(z(e.value, o, a)),
                t.push("<br>");
            }),
            t.join("")
          );
  ...
  function I(e) {
    ...
    return (
      ...
      !!(t = Object.keys(v).map(function (e, t) {
        ...
        return (
          "value" === m &&
            ((n.barGap = p), (n.barCategoryGap = "1%"), null == r && (r = $)),
          null != r && M(n, "itemStyle.normal.opacity", r),
          n
        );
      })).length && t
    );
  ...
  var U = function (e, t, i, n) {
      var a = j(t),
        ...
        y = void 0 === b ? [!1, !1] : b,
        g = i.min,
        x = void 0 === g ? [null, null] : g,
        w = i.max,
        S = void 0 === w ? [null, null] : w,
        A = i.legendName,
        O = void 0 === A ? {} : A,
        M = i.labelMap,
        V = void 0 === M ? {} : M,
        ...
        H = e.slice();
      o.top && o.bottom
        ? (H = o.top.concat(o.bottom))
        : o.bottom && !o.right
        ? (H = o.bottom)
        : i.metrics
        ? (H = i.metrics)
        : H.splice(e.indexOf(l[0]), 1);
      var F = i.xAxisType || ["normal", "normal"],
        _ = i.yAxisType || "category",
        P = i.xAxisName || [],
        D = i.yAxisName || "";
      if (v) {
        var q = v.label,
      ...
      var U = J(a, l),
        Y = C && Z({ metrics: H, labelMap: V, legendName: O }),
        X = G({
          innerRows: a,
          dimAxisName: D,
          dimension: l,
    ...
    Y = function (e, t, i, n) {
      ...
      var H = n.tooltipVisible,
        F = n.legendVisible,
        _ = e.slice();
      o.left && o.right
        ? (_ = o.left.concat(o.right))
        : o.left && !o.right
        ? (_ = o.left)
        : i.metrics
        ? (_ = i.metrics)
        : _.splice(e.indexOf(l[0]), 1);
      var P = i.yAxisType || ["normal", "normal"],
        D = i.xAxisType || "category",
        q = i.yAxisName || [],
        $ = i.xAxisName || "",
        U = J(a, l),
        Y = F && Z({ metrics: _, labelMap: O, legendName: V }),
        X = G({
          innerRows: a,
          dimAxisName: $,
          dimension: l,
    ...
    X = {
      render: function () {
        var e = this.$createElement,
          t = this._self._c || e;
        return t("div", { staticClass: "v-charts-component-loading" }, [
  ...
  var ee = {
      render: function (e) {
        return e(
          ...
          {
            class: [
              ((t = this.$options.name || this.$options._componentTag),
          ...
          [
            ...
            e(K, { style: { display: this.dataEmpty ? "" : "none" } }),
            e(X, { style: { display: this.loading ? "" : "none" } }),
            this.$slots.default,
          ]
        );
        var t;
      ...
      watch: {
        ...
        settings: {
          ...
          handler: function (e) {
            e.type &&
              this.chartLib &&
              (this.chartHandler = this.chartLib[e.type]),
              this.changeHandler();
          },
        },
      ...
      methods: {
          ...
          if (this.chartHandler) {
            ...
            s &&
              ("function" == typeof s.then
                ? s.then(this.optionsHandler)
                : this.optionsHandler(s));
          }
        },
        ...
        optionsHandler: function (t) {
          ...
          if (
            (this.legendPosition &&
              t.legend &&
              ((t.legend[this.legendPosition] = 10),
              ~["left", "right"].indexOf(this.legendPosition) &&
                ((t.legend.top = "middle"), (t.legend.orient = "vertical"))),
            (t.color = this.chartColor),
            ...
            this.markArea || this.markLine || this.markPoint)
          ) {
            var n = {
          ...
          this.extend &&
            ...
            this.afterConfig && (t = this.afterConfig(t));
          var r = this.setOptionOpts;
          (!this.settings.bmap && !this.settings.amap) || k(r) || (r = !1),
            this.notSetUnchange &&
              this.notSetUnchange.length &&
              (this.notSetUnchange.forEach(function (e) {
                var n = t[e];
                n &&
                  (!(function e(t, i) {
                    if (t === i) return !0;
                    ...
                    for (var s in i)
                      if (E(i, s) && "undefined" === N(t)[s]) return !1;
                    return !0;
                  })(n, i._store[e])
                    ? (i._store[e] = j(n))
                    : (t[e] = void 0));
              }),
              k(r) ? (r.notMerge = !1) : (r = !1)),
            this._isDestroyed ||
              (this.log && console.log(t),
              this.echarts.setOption(t, r),
              this.$emit("ready", this.echarts, t, e),
              this._once["ready-once"] ||
                ((this._once["ready-once"] = !0),
                this.$emit("ready-once", this.echarts, t, e)),
              this.judgeWidth && this.judgeWidthHandler(t),
              this.afterSetOption && this.afterSetOption(this.echarts, t, e),
              this.afterSetOptionOnce &&
                !this._once.afterSetOptionOnce &&
                ((this._once.afterSetOptionOnce = !0),
                this.afterSetOptionOnce(this.echarts, t, e)));
        },
        judgeWidthHandler: function (e) {
          var t = this,
            i = this.widthChangeDelay,
            n = this.resize;
          this.$el.clientWidth || this.$el.clientHeight
            ? n()
            : this.$nextTick(function (e) {
                t.$el.clientWidth || t.$el.clientHeight
                  ? n()
        ...
        resizeableHandler: function (e) {
          e && !this._once.onresize && this.addResizeListener(),
            !e && this._once.onresize && this.removeResizeListener();
        },
        init: function () {
          if (!this.echarts) {
            var i = this.themeName || this.theme || t;
            (this.echarts = e.init(this.$refs.canvas, i, this.initOptions)),
              this.data && this.changeHandler(),
              this.createEventProxy(),
              this.resizeable && this.addResizeListener();
          }
        },
        addResizeListener: function () {
          window.addEventListener("resize", this.resizeHandler),
            (this._once.onresize = !0);
        },
        removeResizeListener: function () {
          window.removeEventListener("resize", this.resizeHandler),
            (this._once.onresize = !1);
        },
        addWatchToProps: function () {
          var e = this,
            t = this._watchers.map(function (e) {
              return e.expression;
            });
          Object.keys(this.$props).forEach(function (i) {
            if (!~t.indexOf(i) && !~o.indexOf(i)) {
              var n = {};
              ~["[object Object]", "[object Array]"].indexOf(T(e.$props[i])) &&
                (n.deep = !0),
                e.$watch(
                  i,
                  function () {
        ...
        createEventProxy: function () {
          var e = this,
            t = this,
            i = Object.keys(this.events || {});
          i.length &&
            i.forEach(function (i) {
              -1 === e.registeredEvents.indexOf(i) &&
                (e.registeredEvents.push(i),
                e.echarts.on(
                  i,
                  (function (e) {
                    return function () {
        ...
        clean: function () {
          this.resizeable && this.removeResizeListener(),
      ...
      created: function () {
        (this.echarts = null),
          ...
          (this._once = {}),
          (this._store = {}),
          (this.resizeHandler = O(this.resize, this.resizeDelay)),
          (this.changeHandler = O(this.dataHandler, this.changeDelay)),
  ...
  var ne = function (e, t, i, n) {
      ...
      var a = i.axisSite,
        r = void 0 === a ? {} : a,
        o = i.yAxisType,
        s = void 0 === o ? ["normal", "normal"] : o,
        l = i.xAxisType,
        c = void 0 === l ? "category" : l,
        u = i.yAxisName,
        d = void 0 === u ? [] : u,
        m = i.dimension,
        p = void 0 === m ? [e[0]] : m,
        ...
        w = void 0 === x ? [!1, !1] : x,
        A = i.min,
        O = void 0 === A ? [null, null] : A,
        M = i.max,
        V = void 0 === M ? [null, null] : M,
        T = i.nullAddZero,
        N = void 0 !== T && T,
        k = i.digit,
        j = void 0 === k ? 2 : k,
        ...
        W = e.slice();
      r.left && r.right
        ? (W = r.left.concat(r.right))
        : r.left && !r.right
        ? (W = r.left)
        : i.metrics
        ? (W = i.metrics)
        : W.splice(e.indexOf(p[0]), 1);
      var I =
          G &&
          (function (e) {
            var t = e.metrics,
            ...
            return i || n
              ...
              : { data: t };
          })({ metrics: W, legendName: C, labelMap: F }),
        Z =
          $ &&
          (function (e) {
            var t = e.axisSite,
        ...
        series: (function (e) {
          ...
          return (
            ...
            n.forEach(function (e) {
              ...
              a && (t.areaStyle = { normal: {} }),
                i.right && (t.yAxisIndex = ~i.right.indexOf(e) ? 1 : 0),
                r && f[e] && (t.stack = f[e]),
                l && (t.label = l),
                c && (t.itemStyle = c),
                u && (t.lineStyle = u),
          ...
          series: (function (e) {
            ...
            if (
              ...
              O.slice(h, O.length).forEach(function (e) {
                ...
                (y[0].data = O.slice(0, h)),
                y[0].data.push({ name: "其他", value: M });
            }
            return y;
          })({
            innerRows: o,
          ...
          (function (e, t) {
            return {
              ...
              formatter: function (i) {
                ...
                return (
                  n.push(r(i.color)),
                  n.push(i.name + ": " + z(i.data.realValue, e, t)),
                  n.join("")
                );
              },
            };
  ...
  var fe = function (e, t, i, n) {
      ...
      var S =
        ...
        A = (function (e, t, i) {
          var n = { indicator: [], shape: "circle", splitNumber: 5 },
            a = {};
          return (
            e.forEach(function (e) {
              t.forEach(function (t) {
              ...
              }),
              {
                formatter: function (e) {
                  ...
                  return (
                    t.push(r(e.color)),
                    t.push(e.name + "<br />"),
                    e.data.value.forEach(function (e, r) {
  ...
  function ye(e, t, i) {
    "object" === (void 0 === e ? "undefined" : x(e))
      ? (t[i] = e)
      : e && (t[i] = { normal: { show: !0 }, emphasis: { show: !0 } });
  }
  function ge(t, i) {
    var n = t._once,
      a = t.registerSign,
      r = t.beforeRegisterMap,
      o = t.beforeRegisterMapOnce,
      s = t.registerSignOnce,
      l = t.position,
      c = t.specialAreas;
    n[a] ||
      (r && (i = r(i)),
  ...
  var xe = function (e, t, i, n) {
      var a = i.position,
        ...
        k = i.mapGrid,
        L = i.itemStyle,
        j = i.positionJsonLink,
        E = i.beforeRegisterMap,
        R = i.beforeRegisterMapOnce,
        C = i.mapURLProfix,
        F = void 0 === C ? "https://unpkg.com/echarts@3.6.2/map/json/" : C,
        _ = i.specialAreas,
        P = void 0 === _ ? {} : _,
        D = i.mapOrigin,
        q = e.slice();
      i.metrics ? (q = i.metrics) : q.splice(e.indexOf(b), 1);
      var $ = n.tooltipVisible,
        G = n.legendVisible,
        B = n.color,
        W = n._once,
        I = {};
        ...
        J =
          ...
          (function (e) {
            ...
            return i || n
              ...
              : { data: t };
          })({ metrics: q, legendName: V, labelMap: N }),
        U = (function (e) {
          var t = e.position,
            i = e.selectData,
            n = e.dimension,
      ...
      return D
        ? (ge(Y, D), { series: U, tooltip: Z, legend: J })
        : H({
            position: o,
            positionJsonLink: j,
            beforeRegisterMapOnce: R,
    ...
    Se = function (e, t, i, n) {
      var a = i.key,
        ...
        l = n._once;
      return (
        a || s || console.warn("settings.key must be a string."),
        l.bmap_register
          ? {}
          : ((l.bmap_register = !0),
            s
              ? { bmap: o }
              : P(a, r).then(function (e) {
                  return { bmap: o };
                }))
      );
    },
  ...
  var Ve = function (e, t, i, n) {
      ...
      if (a)
        return {
          ...
          })({ itemDataType: d[0], linksDataType: d[1], digit: p }),
          series: (function (e) {
            var t = e.rows,
              i = e.dimension,
              n = e.metrics,
  ...
  var je = function (t, i, o, s) {
      var l = o.type,
        c = void 0 === l ? "cartesian" : l,
        u = o.xAxisList,
        d = o.yAxisList,
        m = o.dimension,
        p = void 0 === m ? [t[0], t[1]] : m,
        h = o.metrics,
        f = void 0 === h ? t[2] : h,
        v = o.dataType,
        b = void 0 === v ? "normal" : v,
        ...
        N = void 0 === T ? "2.0" : T,
        k = o.position,
        L = o.positionJsonLink,
        j = o.beforeRegisterMap,
        E = o.pointSize,
        R = void 0 === E ? 10 : E,
        C = o.blurSize,
        F = void 0 === C ? 5 : C,
        ...
        q = o.yAxisName,
        $ = o.xAxisName,
        G = o.beforeRegisterMapOnce,
        B = o.mapURLProfix,
        W = void 0 === B ? "https://unpkg.com/echarts@3.6.2/map/json/" : B,
        I = o.specialAreas,
        Z = void 0 === I ? {} : I,
        J = s.tooltipVisible,
        U = u,
      ...
      t.forEach(function (e) {
        ...
        "cartesian" === c
          ? ((U && U.length) || (U = Ne(i, p[0])),
            (Y && Y.length) || (Y = Ne(i, p[1])),
            (X = ke({
              rows: i,
              innerXAxisList: U,
              innerYAxisList: Y,
      ...
      var ee = f
        ...
        : [0, 5];
      ee.length || (ee = [0]);
      var te = y || Math.min.apply(null, ee),
        ie = g || Math.max.apply(null, ee),
        ne = Le(U, $),
        ae = Le(Y, q),
        re = [{ type: "heatmap", data: { chartData: X }.chartData }],
        oe = (function (e) {
          var t = e.innerMin,
            i = e.innerMax,
            r = e.type,
        ...
        })({ innerMin: te, innerMax: ie, type: c, heatColor: _, series: re }),
        se =
          J &&
          (function (e) {
            var t = e.dataType,
      ...
      return "bmap" === c
        ...
        : "map" === c
        ? ((le.series[0].coordinateSystem = "geo"),
          H({
            position: k,
            positionJsonLink: L,
  ...
  var Re = function (e, t, i, n) {
      var a = i.dimension,
        r = void 0 === a ? e[0] : a,
        o = i.metrics,
        s = void 0 === o ? [e[1], e[2]] : o,
        l = i.dataType,
        c = void 0 === l ? {} : l,
        u = i.xAxisType,
        d = void 0 === u ? "category" : u,
        m = i.xAxisName,
        p = i.yAxisName,
        h = i.digit,
        f = void 0 === h ? 2 : h,
        ...
        series: (function (e) {
          ...
          return (
            i.forEach(function (e) {
              ...
              t[e].forEach(function (e) {
                var t = { value: [] };
                t.value.push(e[r], e[a[0]], e[a[1]]),
                  h.forEach(function (i) {
                    t.value.push(e[i]);
                  }),
                  (t.symbolSize = u || (e[a[1]] / v) * c),
                  i.push(t);
              }),
                b.push({
                  type: "scatter",
  ...
  var Pe = function (e, t, i, n) {
      ...
      var G =
          ...
          })({ showMA: g, MA: b, legendName: f, labelMap: p }),
        B =
          C &&
          (function (e) {
            var t = e.metrics,
            ...
            return {
              ...
              formatter: function (e) {
                var o = [];
                return (
                  o.push(e[0].axisValue + "<br>"),
                  e.forEach(function (e) {
                    var s = e.data,
                      l = e.seriesName,
                      c = e.componentSubType,
                      u = e.color,
                      d = null == a[l] ? l : a[l];
                    if ((o.push(r(u) + " " + d + ": "), "candlestick" === c))
                      o.push("<br>"),
                        t.slice(0, 4).forEach(function (e, t) {
                          var r = null != a[e] ? a[e] : e,
                            l = z(s[t + 1], i, n);
                          o.push("- " + r + ": " + l + "<br>");
                        });
                    else if ("line" === c) {
          ...
          })({ metrics: l, dataType: R, digit: u, labelMap: p }),
        W =
          w &&
          (function (e) {
            var t = e.downColor,
          ...
          })({ downColor: M, upColor: T, MA: b, showMA: g }),
        I =
          A &&
          (function (e) {
            var t = e.start,
              i = e.end;
            return [
              { type: "inside", xAxisIndex: [0, 1], start: t, end: i },
              {
                show: !0,
                xAxisIndex: [0, 1],
                type: "slider",
      ...
      return {
        ...
        series: (function (e) {
          var t = e.values,
            ...
            d = { normal: { opacity: 0.5 } },
            m = [
              {
                name: null == l[Fe] ? Fe : l[Fe],
                type: "candlestick",
                data: t,
                itemStyle: u,
              },
          ...
          (function (e) {
            ...
            return {
              formatter: function (e) {
                ...
                var l = [];
                return (
                  l.push(a + ": "), l.push(z(o, i[a], n) + " " + s), l.join("")
                );
              },
            };
          })({ tooltipFormatter: y, dataType: d }),
        series: (function (e) {
          var t = e.rows,
            i = e.dimension,
            n = e.metrics,
  ...
  var Ge = function (e, t, i, n) {
      ...
      return {
        ...
        tooltip: m && {
          trigger: "item",
          triggerOn: "mousemove",
          formatter: { tooltipFormatter: d }.tooltipFormatter,
        },
      };
    },
    Be = S({}, ee, {
  ...
  var We = function (e, t, i, n) {
      ...
      return {
        tooltip:
          ...
          })({ tooltipFormatter: b, dataType: d, digit: p }),
        series: (function (e) {
          var t = e.dimension,
            i = e.metrics,
            n = e.seriesMap,
          ...
          return a.slice().map(function (e, a) {
            var l = [],
              ...
              m = {};
            return (
              L(n) ? (m = n[a] ? n[a] : n[s - 1]) : k(n[u]) && (m = n[u]),
              L(r) && L(r[0]) && (o = L(r[a]) ? r[a] : r[r.length - 1]),
              l.push({ value: d }),
              o &&
                o.length &&
                (l = l.concat(
      ...
      return {
        series: (function (e) {
          var t = e.dimension,
            ...
            c = L(a) ? a.length : 0,
            u = n.slice().map(function (e) {
              var n = { name: e[t], value: e[i] };
              return (
                c > 0 &&
                  (n.textStyle = {
                    normal: { color: a[Math.floor(Math.random() * c)] },
                  }),
                n
              );
            });
  ...
  return (
    "undefined" != typeof window && window.Vue && Ye(window.Vue),
    {
      VeBar: te,
      VeHistogram: ie,
      VeRing: ue,
