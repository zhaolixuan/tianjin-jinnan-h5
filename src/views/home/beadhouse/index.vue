 ...
 * @LastEditTime: 2022-12-02 15:54:27
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \city-yanglao-H5\src\views\home\beadhouse\index.vue
 * 
 -->
<template>
  <div class="container">
...
export default {
  ...
  data() {
    return {
      ...
      headerCategoryData: [
        { typeName: "不限", typeValue: "" },
        { typeName: "公办", typeValue: "公办" },
        { typeName: "民办", typeValue: "民办" },
      ],
      currentIndex: 0,
      policyList: [],
      paramsData: {},
  ...
  methods: {
    ...
    listData() {
      ...
      let data = {
        ...
        nature: this.paramsData.mealCategory,
