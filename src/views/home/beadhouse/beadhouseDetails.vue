 ...
 * @LastEditTime: 2022-12-01 09:30:06
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \city-yanglao-H5\src\views\home\beadhouse\beadhouseDetails.vue
 * 
 -->
<template>
  <div class="content">
        ...
        this.serviceContentData = [
          {
            ...
            charges:
              this.contentData.chargesMin + "-" + this.contentData.chargesMa,
            nature: this.contentData.nature,
          },
        ];
      });
    },
