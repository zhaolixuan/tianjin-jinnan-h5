 ...
 * @LastEditTime: 2023-02-04 16:25:45
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \city-yanglao-H5\src\views\home\day-care\index.vue
 * 
 -->
<template>
  <div class="container">
...
import ServiceBodyList from "./component/ServiceBodyList.vue";
...
export default {
  ...
  //  this.getAreaStrComList({ type: 2 });
    this.getAreaStrComList({ type: 3, parentCode: '120112000000' });
  },
  methods: {
    onRefresh() {
      this.pageNo = 1;
